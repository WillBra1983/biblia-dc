...
export default function EstudoBiblicoIaPericope() {
  ...
  }, [ehAdmin, livroQ, capQ, iniQ, fimQ, tomCarregado])
  ...
  }, [ehAdmin, origem, livroQ, capQ, iniQ, fimQ, tomCarregado, gerar])
      ...
      <Paper elevation={0} square sx={{
        ...
        {fase === 'ready' && (
          <Stack direction="row" spacing={0.25} alignItems="center" flexWrap="wrap" justifyContent="flex-end">
            ...
            <Tooltip title={acoesDesabilitadas ? 'Avalie antes para usar esta opção' : 'Editar e salvar como seu estudo'}>
              <span>
                <Button
                  size="small"
                  variant="contained"
